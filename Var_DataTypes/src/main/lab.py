...
def demonstrate_string():
    ...
    Returns:
        str: A string value.
    """
    my_string = "Hello, Python!"  # Assign a string value to the variable
    return my_string
...
def demonstrate_create_areas_list():
    ...
    Returns:
        list: A list containing the area values.
    """
    hall = 10
    kit = 20
    liv = 30
...
def demonstrate_variable_scope():
    ...
    Challenge:
    Observe the error message generated when attempting to print local_var1 inside function1.
    Correct the error to successfully print local_var1 inside function1.
    Understand the concept of variable scope in Python and how it affects accessing variables inside nested functions.
